              ...
              return(
                <div className="group text-center" key={index}>
                    <div className="relative inline-block mx-auto size-52 rounded-full! overflow-hidden">
                        ...
                        <div className="absolute inset-0 bg-linear-to-b from-transparent to-black size-52 rounded-full! opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out"></div>
