...
export default function IndexThirteen(){
    ...
    return(
        ...
        <section className="relative xl:pt-120 lg:pt-112 md:pt-108 pt-80 pb-8 bg-no-repeat bg-center bg-cover bg-fixed" style={{backgroundImage:`url(${"/images/bg/8.jpg"})`}}>
