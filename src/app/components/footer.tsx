                                ...
                                <div className="grid md:grid-cols-12 grid-cols-1 gap-7.5 -mt-24">
                                    ...
                                    <div className="lg:col-span-2 md:col-span-4">
                                        ...
                                        <ul className="list-none footer-list mt-6">
                                            ...
                                            <li className="mt-2.5"><Link href="/features" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Services</span> </Link></li>
                                            <li className="mt-2.5"><Link href="/pricing" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Pricing</span> </Link></li>
                                            <li className="mt-2.5"><Link href="/blogs" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Blog</span> </Link></li>
                                            <li className="mt-2.5"><Link href="/auth-login" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Login</span> </Link></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="lg:col-span-3 md:col-span-4">
                                        ...
                                        <ul className="list-none footer-list mt-6">
                                              ...
                                              <li className="mt-2.5"><Link href="/privacy" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Privacy Policy</span> </Link></li>
                                              <li className="mt-2.5"><Link href="/grid" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Listing</span> </Link></li>
                                              <li className="mt-2.5"><Link href="/contact" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span> Contact</span> </Link></li>
                                        </ul>
                                    </div>
