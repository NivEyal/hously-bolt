            ...
            <div className="swiper-container absolute inset-e-0 top-0 size-full">
                <Swiper className="swiper-wrapper"   
                    ...
                    <SwiperSlide className="swiper-slide flex items-center overflow-hidden">
                        <div className="slide-inner absolute inset-e-0 top-0 size-full slide-bg-image flex items-center bg-center;" style={{backgroundImage:`url('/images/bg/01.jpg')`, height:'100vh'}}>
                    ...
                    <SwiperSlide className="swiper-slide flex items-center overflow-hidden">
                        <div className="slide-inner absolute inset-e-0 top-0 size-full slide-bg-image flex items-center bg-center;" style={{backgroundImage:`url('/images/bg/02.jpg')`, height:'100vh'}}>
                            <div className="absolute inset-0 bg-slate-900/70"></div>
                            <div className="container relative">
                                <div className="grid grid-cols-1">
                                    <div className="text-center">
