            ...
            <div className="container lg:mt-24 mt-16">
                ...
                <div className="flex justify-center relative mt-16">
                    <div className="relative lg:w-1/3 md:w-1/2 w-full">
                        <div className="absolute -top-20 md:-inset-s-24 -inset-s-0">
                            <i className="mdi mdi-format-quote-open text-9xl opacity-5"></i>
                        </div>

                        <div className="absolute bottom-28 md:-inset-e-24 -inset-e-0">
                                    ...
                                    <div className="tiny-slide" key={index}>
                                        <div className="text-center">
                                            ...
                                            <div className="text-center mt-5">
                                                ...
                                                <Image src={el.profile} className="size-14 rounded-full! shadow-md shadow-gray-200 dark:shadow-gray-700 mx-auto" alt="" height={56} width={56} priority />
