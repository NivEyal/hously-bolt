    ...
    return (
        <>
            ...
            <div className="fixed top-1/4 -left-2 z-3">
                <span className="relative inline-block rotate-90">
                    ...
                    <label className="label bg-slate-900 dark:bg-white shadow-sm shadow-gray-200 dark:shadow-gray-700 cursor-pointer rounded-full! flex justify-between items-center p-1 w-14 h-8" htmlFor="chk">
                        ...
                        <span className="ball bg-white dark:bg-slate-900 rounded-full! absolute top-0.5 inset-s-0.5 size-7"></span>
                    </label>
                </span>
            </div>
            ...
            <Link  href="#" onClick={scrollToTop}
                id="back-to-top" className={`${!scrollToTops ? "hidden":"back-to-top fixed text-lg rounded-full! z-10 bottom-5 inset-e-5 h-9 w-9 text-center bg-primary text-white justify-center items-center flex"}`}><FiArrowUp width={18}/></Link>
            {/* <!-- LTR & RTL Mode Code --> */}
