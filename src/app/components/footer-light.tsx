                                ...
                                <div className="grid md:grid-cols-12 grid-cols-1 gap-7.5 -mt-24">
                                    ...
                                    <div className="lg:col-span-2 md:col-span-4">
                                        ...
                                        <ul className="list-none footer-list mt-6">
                                            ...
                                            <li className="mt-2.5"><Link href="/features" className="text-slate-400 inline-flex hover:text-slate-500 dark:text-slate-300 dark:hover:text-slate-400 duration-500 ease-in-out"><MdKeyboardArrowRight className="me-1 text-xl"/> Services</Link></li>
                                            <li className="mt-2.5"><Link href="/pricing" className="text-slate-400 inline-flex hover:text-slate-500 dark:text-slate-300 dark:hover:text-slate-400 duration-500 ease-in-out"><MdKeyboardArrowRight className="me-1 text-xl"/> Pricing</Link></li>
                                            <li className="mt-2.5"><Link href="/blog" className="text-slate-400 inline-flex hover:text-slate-500 dark:text-slate-300 dark:hover:text-slate-400 duration-500 ease-in-out"><MdKeyboardArrowRight className="me-1 text-xl"/> Blog</Link></li>
                                            <li className="mt-2.5"><Link href="/auth-login" className="text-slate-400 inline-flex hover:text-slate-500 dark:text-slate-300 dark:hover:text-slate-400 duration-500 ease-in-out"><MdKeyboardArrowRight className="me-1 text-xl"/> Login</Link></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="lg:col-span-3 md:col-span-4">
                                        ...
                                        <ul className="list-none footer-list mt-6">
                                            ...
                                            <li className="mt-2.5"><Link href="/privacy" className="text-slate-400 inline-flex hover:text-slate-500 dark:text-slate-300 dark:hover:text-slate-400 duration-500 ease-in-out"><MdKeyboardArrowRight className="me-1 text-xl"/> Privacy Policy</Link></li>
                                            <li className="mt-2.5"><Link href="/listing-one" className="text-slate-400 inline-flex hover:text-slate-500 dark:text-slate-300 dark:hover:text-slate-400 duration-500 ease-in-out"><MdKeyboardArrowRight className="me-1 text-xl"/> Listing</Link></li>
                                            <li className="mt-2.5"><Link href="/contact" className="text-slate-400 inline-flex hover:text-slate-500 dark:text-slate-300 dark:hover:text-slate-400 duration-500 ease-in-out"><MdKeyboardArrowRight className="me-1 text-xl"/> Contact</Link></li>
                                        </ul>
                                    </div>
