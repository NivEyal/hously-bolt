                ...
                <div className={`${topnavClass !== '' && topnavClass !== undefined ? 'container-fluid md:px-8 px-3' : 'container'}`}>
                    ...
                    <div id="navigation" className={`${isOpen === true ? 'hidden' : '!block'}`} >
                        ...
                        <ul className={`navigation-menu  ${navClass === '' || navClass === undefined ? '' : 'nav-light'}   ${topnavClass !== '' && topnavClass !== undefined ? 'justify-center!' : 'justify-end!'}`}>
                            <li className={`has-submenu parent-menu-item ${["/", "/index-two", "/index-three", "/index-four","/index-five", "/index-six", "/index-seven","/index-eight","/index-nine","/index-ten","/index-eleven","/index-twelve","/index-thirteen","/index-fourteen"].includes(manu) ? 'active' : ''}`}>
                                <Link href="#" onClick={(e)=>{setSubManu(subManu === "/index-item" ? "" : "/index-item")}}>Home</Link><span className="menu-arrow"></span>
                                <ul className={`submenu megamenu ${["/", "/index-two", "/index-three", "/index-four", "/index-five", "/index-six","/index-seven","/index-item","/index-eight","/index-nine","/index-ten","/index-eleven","/index-twelve","/index-thirteen","/index-fourteen"].includes(subManu) ? 'open' : ''}`}>
                                    <li>
                                        <ul>
                                    ...
                                    <li>
                                            ...
                                            <li className={manu ===  "/index-eleven" ? 'active' : '' }>
                                                <Link href="/index-eleven" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        ...
                                                        <span className="lg:mt-2 block">Hero Eleven</span>
                                                    </div>
                                                </Link>
                                            </li>
                                            <li className={manu ===  "/index-twelve" ? 'active' : '' }>
                                                <Link href="/index-twelve" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        ...
                                                        <span className="lg:mt-2 block">Hero Twelve </span>
                                                    </div>
                                                </Link>
                                            </li>
                                        </ul>
                                     ...
                                     <li>
                                        <ul>
                                            <li className={manu ===  "/index-thirteen" ? 'active' : '' }>
                                                <Link href="/index-thirteen" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-thirteen.png' width={183} height={124} className="img-fluid rounded shadow-md" alt=""/></span>
                                                        <span className="lg:mt-2 block">Hero Thirteen<span className="bg-red inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></span>
                                                    </div>
                                                </Link>
                                            </li>
                                            <li className={manu ===  "/index-fourteen" ? 'active' : '' }>
                                                <Link href="/index-fourteen" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-fourteen.png' width={183} height={124} className="img-fluid rounded shadow-md" alt=""/></span>
                                                        <span className="lg:mt-2 block">Hero Fourteen <span className="bg-red inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></span>
                                                    </div>
                                                </Link>
                                            </li>
                                        </ul>
                            ...
                            <li className={`has-submenu parent-parent-menu-item ${["/grid", "/grid-sidebar", "/grid-map", "/list", "/list-sidebar", "/list-map", "/property-detail/1","/property-detail-two"].includes(manu) ? 'active' : ''}`}>
                                ...
                                <ul className={`submenu ${["/grid", "/grid-sidebar", "/grid-map", "/list", "/list-sidebar", "/list-map", "/property-detail/1", "/list-item", "/grid-view-item", "/list-view-item", "/property-item","/property-detail-two"].includes(subManu) ? 'open' : ''}`}>
                                    <li className={`has-submenu parent-menu-item ${["/grid", "/grid-sidebar", "/grid-map"].includes(manu) ? 'active' : ''}`}><Link href="#" onClick={() =>{setSubManu(subManu === "/grid-view-item" ? "" : "/grid-view-item")}}> Grid View </Link><span className="submenu-arrow"></span>
                                        <ul className={`submenu ${["/grid", "/grid-sidebar", "/grid-map","/grid-view-item"].includes(subManu) ? 'open' : ''}`}>
                            ...
                            <li className={`has-submenu parent-parent-menu-item ${["/aboutus", "/features", "/pricing", "/faqs", "/auth-login", "/auth-signup", "/auth-reset-password", "/terms", "/privacy", "/blogs", "/blog-sidebar", "/blog-detail", "/comingsoon", "/maintenance", "/404","/agents", "/agent-profile","/agencies", "/agency-profile"].includes(manu) ? 'active' : ''}`}>
                                ...
                                <ul className={`submenu ${["/aboutus", "/features", "/pricing", "/faqs", "/auth-login", "/auth-signup", "/auth-reset-password", "/terms", "/privacy", "/blogs", "/blog-sidebar", "/blog-detail", "/comingsoon", "/maintenance", "/404","/agents-item","/agencies-item","/page-item","/auth-item","/term-item","/blog-item", "/special-item"].includes(subManu) ? 'open' : ''}`}>
                                    ...
                                    <li className={`has-submenu parent-menu-item ${["/agents", "/agent-profile"].includes(manu) ? 'active' : ''}`}><Link href="#" onClick={()=>{setSubManu(subManu === "/agents-item" ? '' : "/agents-item")}}> Agents </Link><span className="submenu-arrow"></span>
                                        <ul className={`submenu ${["/agents", "/agent-profile","/agents-item"].includes(subManu) ? 'open' : ''}`}>
                                    ...
                                    <li className={`has-submenu parent-menu-item ${["/agencies", "/agency-profile"].includes(manu) ? 'active' : ''}`}><Link href="#" onClick={()=>{setSubManu(subManu === "/agencies-item" ? '' : "/agencies-item")}}> Agencies </Link><span className="submenu-arrow"></span>
                                        <ul className={`submenu ${["/agencies", "/agency-profile","/agencies-item"].includes(subManu) ? 'open' : ''}`}>
